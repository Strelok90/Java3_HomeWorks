...
import ru.geekbrains.java2.chat.clientserver.commands.ChangeNickCommandData;
...
import static ru.geekbrains.java2.chat.server.chat.MyServer.file;

import static ru.geekbrains.java2.chat.clientserver.Command.*;

public class ClientHandler {

    public static final int TIMEOUT = 12 * 1200;
        ...
        new Thread(() -> {
            try {
                ...
                try {
                    ...
                    file.warn("Failed to close connection!");
        ...
        timeoutTimer.schedule(new TimerTask() {
            ...
            public void run() {
                try {
                    synchronized (this) {
                        if (nickname == null) {
                            file.info("Истекло время ожидания подключения!");
    ...
    private Command readCommand() throws IOException {
        ...
        try {
            ...
            file.info("Failed to read Command class");
